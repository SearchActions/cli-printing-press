...
func TestGenerateOAuth2RefreshAuth(t *testing.T) {
	...
	assert.Contains(t, configSrc, `const specTokenURL = "https://auth.example.com/oauth/token"`,
		"the spec TokenURL is the pinned default that ResolveTokenURL falls back to")

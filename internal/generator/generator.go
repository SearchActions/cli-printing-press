...
func (g *Generator) renderSingleFiles() error {
	singleFiles := map[string]string{
		...
		"cliutil_privperms_windows.go.tmpl":        filepath.Join("internal", "cliutil", "privperms_windows.go"),
		"cliutil_privperms_unix.go.tmpl":           filepath.Join("internal", "cliutil", "privperms_unix.go"),

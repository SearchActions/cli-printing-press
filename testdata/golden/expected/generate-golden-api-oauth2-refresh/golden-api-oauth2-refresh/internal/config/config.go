...
func ResolveTokenURL(override string) (string, error) {
	...
	if got.Scheme != "https" {
		return "", fmt.Errorf("token_url %q must use https (the token exchange carries client_secret and refresh_token)", override)
	}

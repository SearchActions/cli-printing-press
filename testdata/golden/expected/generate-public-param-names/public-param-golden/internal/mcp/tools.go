...
func RegisterTools(s *server.MCPServer) {
	s.AddTool(
		...
		makeAPIHandler("POST", "/stores", false, false, nil, []mcpParamBinding{{PublicName: "dry-run-2", WireName: "$dry_run", Location: "query"}, {PublicName: "store-code", WireName: "store_code", Location: "body"}}, []string{}),
	)
	s.AddTool(
